<?php
	...
	if (isset($_POST['name']) && isset($_POST['quantity']) && isset($_POST['food']) ) {
    	$name=$_POST['name'];
    	$quantity=$_POST['quantity'];
    	$food=$_POST['food'];
    	
    	if (!empty($name) && !empty($quantity) && !empty($food) ) {
    		if (add_nutrition($name,$quantity,$food)) {
...
<html lang="en" dir="ltr">
	<head>
		<meta charset="UTF-8">
		<title><?= $application_name; ?> | New Nutrition Items</title>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark"><small>New Nutrition Items</small></h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									<li class="breadcrumb-item"><a href="<?= $base_url; ?>dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
									<li class="breadcrumb-item active">New Nutrition Items</li>
								</ol>
							</div>
							<!-- /.col -->
						</div>
					...
					<div class="card">
						<div class="card-header">
							<ul class="nav nav-tabs align-items-end card-header-tabs w-100">
								<li class="nav-item">
									<a class="nav-link active" href="#"><i class="fa fa-list mr-2"></i>New Nutrition items</a>
								</li>
							</ul>
						</div>
					            ...
					            <div class="row">
					            	<div class="col-md-7">
							        	...
							        	<div class="form-group">
							        		...
							        		<input type="text" name="food" class="form-control" id="food" placeholder="Enter food ">
							        	</div>
