...
<?php
    ...
    function add_package_name($name){
    	if (authenticated() &&!empty($name) ) {
    		$statement=get_connection()->prepare("INSERT INTO `package`(`name`)VALUES(?)");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Package Name</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Package Name</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
