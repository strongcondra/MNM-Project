<?php
  ...
  $help_questions = get_service_help_questions();
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=$base_url;?>help/list-help.php">Home</a></li>
                             ...
                             <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                                ...
                                <?php
                                  if (!empty($help_questions)) {
                                    foreach ($help_questions as $item) {
                                      echo "<tr><td>{$item['question']}</td><td>{$item['answer']}</td><td><a href=\"delete-help-question.php?id={$item['id']}\" title=\"Delete\"class=\"btn btn-danger\">Delete</a></td></tr>";
                                    }
                                  }
                                ?>
                                </tbody>
