...
<head>
  ...
  <title>List of Active Cafés</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Active Cafés</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              ...
                              <thead>
                                 <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Location</th>
                                     <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Popular</th>
                                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Trending</th>
                              ...
                              <?php
                               if (!empty($cafes)) {
                                    foreach ($cafes as $item) {
                                      echo "<tr><td>{$item['owner_name']} {$item['owner_mob']}</td><td>{$item['cafe_name']}</td><td>{$item['location']}</td><td>" .  ($item['popular'] == 'true' ? "<span class=\"label-success label label-default\">Popular</span>" : ($item['popular'] == 'false' ? "<span class=\"label-warning label label-default\" style=\" color:red \">Not Popular</span>" : "<span class=\"label label-default\">New Cafe</span>")) . "</td><td>" .  ($item['trending'] == 'true' ? "<span class=\"label-success label label-default\">Trending</span>" : ($item['trending'] == 'false' ? "<span class=\"label-warning label label-default\" style=\" color:red \">Not Trending</span>" : "<span class=\"label label-default\">New Cafe</span>")) . "</td><td><img src=\"{$client_url}images/cafe/{$item['primary_image']}\" height='120' width='150' alt='{$item['primary_image']}' /></td><td>{$item['cuisine']}</td><td>{$item['description']}</td><td style=\"white-space: nowrap;\"> <a href=\"delete-cafe.php?id={$item['cafe_id']}\" title=\"Delete\"class=\"btn btn-danger\"> Delete </a> &nbsp &nbsp; &nbsp; &nbsp;&nbsp;<a href=\"deactivate-cafe.php?id={$item['cafe_id']}\" class=\"btn btn-success\" title=\"Suspend\">Suspend</a> &nbsp &nbsp; &nbsp; &nbsp;&nbsp;<a href=\"edit-cafe.php?id={$item['cafe_id']}\" class=\"btn btn-success\" title=\"Edit\">Edit</a> </td></tr>";
                                    }
                               }
                               ?>
                              </tbody>
