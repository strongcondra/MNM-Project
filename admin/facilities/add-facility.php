...
<?php
    ...
    function add_facility($name){
    	if (authenticated() &&!empty($name) ) {
    		$statement=get_connection()->prepare("INSERT INTO `facilities`(`name`)VALUES(?)");
      ...
      <div class="card card-primary">
              ...
              <form action="" method="post">
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter facility">
                  </div>
                <!-- /.card-body -->
