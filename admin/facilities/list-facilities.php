...
<?php
    ...
    function list_facilities(){
        if(authenticated()){
			$statement = get_connection()->prepare("SELECT `id`, `name`  FROM `facilities`");
			$statement->execute();
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Facilities</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              ...
                              <tbody>
                               ...
                               if (!empty($facilities)) {
                                    foreach ($facilities as $item) {
                                      echo "<tr><td>{$item['id']}</td><td>{$item['name']}</td><td><a href=\"delete-facility.php?id={$item['id']}\"class=\"btn btn-danger\"  title=\"Delete\">Delete</a> &nbsp &nbsp <a href=\"{$base_url}facilities/edit-facility.php?id={$item['id']}\" class=\"btn btn-success\" title=\"Edit\">Edit</a></td></tr>";
                                    }
                               }
                               ?>
                              </tbody>
