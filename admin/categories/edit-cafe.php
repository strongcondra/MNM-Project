<?php
  ...
  if (isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password'])&& isset($_POST['terms']) && isset($_POST['privacyPolicy']) && isset($_POST['refundPolicy']) ) {
  	...
  	if (!empty($username) && !empty($email) && !empty($password) ) {
  		if (!registered_user($email) &&  add_administrator($username,$email,$password,$terms,$privacyPolicy,$refundPolicy)) {
  ...
  $cafe_details = get_cafe_details($id);
?>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?=$base_url;?>admin/cafe/edit-cafe.php?id=<?= $cafe_id; ?>">Home</a></li>
