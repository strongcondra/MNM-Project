                              ...
                              <div class="row">
                                 <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                                       <thead>
                                          <tr role="row">
                                             <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Category ID</th>
                                       ...
                                       <tbody>
                                          ...
                                          if (!empty($categories)) {
                                             foreach ($categories as $item) {
                                                echo "<tr><td>{$item['id']}</td><td>{$item['name']}</td><td>{$item['description']}</td><td><img src=\"{$client_url}images/categories/{$item['image']}\" height='45' width='45' alt='{$item['image']}' /><td><a href=\"delete-categories.php?id={$item['id']}\"class=\"btn btn-danger\">Delete</a> &nbsp &nbsp <a href=\"{$base_url}categories/edit-categories.php?id={$item['id']}\" class=\"btn btn-success\" title=\"Edit\">Edit</a></td></tr>";
                                             }
                                          }
                                          ?>
                                       </tbody>
