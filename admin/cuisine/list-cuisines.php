               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">List of Cuisine</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
                              ...
                              <div class="row">
                                 <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                                       <thead>
                                          <tr role="row">
                                             <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Cuisine ID</th>
                                             ...
                                             <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Restaurant</th>
                                       ...
                                       <tbody>
                                          ...
                                          if (!empty($cuisine)) {
                                             foreach ($cuisine as $item) {
                                                echo "<tr><td>{$item['id']}</td><td>{$item['name']}</td><td>{$item['description']}</td><td>{$item['restaurants']}</td><td><img src=\"{$client_url}images/cuisines/{$item['image']}\" height='45' width='45' alt='{$item['image']}' /></td><td><a href=\"delete-cuisine.php?id={$item['id']}\"class=\"btn btn-danger\">Delete</a> &nbsp &nbsp <a href=\"{$base_url}cuisine/edit-cuisine.php?id={$item['id']}\" class=\"btn btn-success\"title=\"Edit\">Edit</a></td></tr>";
                                             }
                                          }
                                          ?>
                                       </tbody>
