        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Favorites</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              ...
                              <tbody>
                               ...
                               if (!empty($favorites)) {
                                    foreach ($favorites as $item) {
                                      echo "<tr><td>{$item['id']}</td><td>{$item['name']}</td><td>{$item['description']}</td><td>{$item['user_mobile']}</td><td><img src=\"{$client_url}images/favorites/{$item['image']}\" height='45' width='45' alt='{$item['image']}' /></td><td><a href=\"delete-favorites.php?id={$item['id']}\" title=\"Delete\"class=\"btn btn-danger\">Delete</a></td></tr>";
                                    }
                               }
                               ?>
                              </tbody>
