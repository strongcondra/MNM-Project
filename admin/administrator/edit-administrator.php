...
<?php
    ...
    if (isset($_POST['id']) &&isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password'])&& isset($_POST['terms']) && isset($_POST['privacyPolicy']) && isset($_POST['refundPolicy']) ) {
      $id =$_POST['id'];
    	...
    	if (!empty($id) &&!empty($username) && !empty($email) ) {
    		if (update_administrator($id,$username,$email,$password,$terms,$privacyPolicy,$refundPolicy)) {
    			update_user("","Administrator successfully updated");
    		}
    	}
    }
  ...
  $rows = get_admin_values($admin_id);
  $id = $rows['id'];
  ...
  $refundPolicy = $rows['refundPolicy'];
    ...
    <section class="content">
      <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit adminstrator</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="" method="post">
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" id="username" name="id" placeholder="Enter username" value="<?php echo $id; ?>" hidden>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" name="terms"><?php echo $terms; ?></textarea>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" name="privacyPolicy"><?php echo $privacyPolicy; ?></textarea>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" name="refundPolicy"><?php echo $refundPolicy; ?></textarea>
                  </div>
