               ...
               <div class="row">
                  <div class="col-12">
                     <div class="card">
                                       ...
                                       <tbody>
                                          ...
                                          if (!empty($photos)) {
                                             ...
                                             foreach ($photos as $item) {
                                                ...
                                                echo "<tr><td>{$item['id']}</td><td>{$item['userid']}</td><td>{$item['place_name']}</td><td><img src=\"{$client_url}images/cafe/{$item['image']}\" height='45' width='45' alt='{$item['image']}' /></td><td><div class='custom-control custom-checkbox'>
                        ...
                        " . ($item['status']=='1'  ? "Active" : "Non-Active") . "</label></div></td> </tr>";
                                             $i++;
