        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Locations</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              ...
                              <tbody>
                               ...
                               if (!empty($location)) {
                                    foreach ($location as $item) {
                                      echo "<tr><td>{$item['id']}</td><td>{$item['name']}</td><td> <a href=\"delete-location.php?id={$item['id']}\" title=\"Delete\"class=\"btn btn-danger\">Delete</a>&nbsp &nbsp <a href=\"{$base_url}location/edit-location.php?id={$item['id']}\" class=\"btn btn-success\" title=\"Edit\">Edit</a></td></tr>";
                                    }
                               }
                               ?>
                              </tbody>
