<?php
	...
	if (isset($_POST['facility']) && isset($_POST['price']) ) {
    	$facility=$_POST['facility'];
    	$price=$_POST['price'];
    	

    	if (!empty($facility) && !empty($price)  ) {
    		if (add_facility($facility,$price)) {
...
<html lang="en" dir="ltr">
	<head>
		<meta charset="UTF-8">
		<title><?= $application_name; ?> | New Facility</title>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark"><small>New Facility</small></h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
					...
					<div class="card">
						<div class="card-header">
							<ul class="nav nav-tabs align-items-end card-header-tabs w-100">
								<li class="nav-item">
									<a class="nav-link active" href="#"><i class="fa fa-list mr-2"></i>New Facility</a>
								</li>
							</ul>
						</div>
					            ...
					            <div class="row">
					            	<div class="col-md-7">
						            	...
						            	<div class="form-group">
							        		...
							        		<input type="text" name="facility" class="form-control" id="name" placeholder="Enter Facility name">
							        	</div>
						            	<div class="form-group">
