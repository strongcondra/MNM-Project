<?php
	...
	function get_item_value($item_id){
        ...
        $statement = get_connection()->prepare("SELECT `id`, `item`,`price` FROM `additionalItems` WHERE `id`=?");
					...
					<div class="card">
						<div class="card-header">
							<ul class="nav nav-tabs align-items-end card-header-tabs w-100">
								<li class="nav-item">
									<a class="nav-link active" href="<?= $base_url; ?>new-item.php"><i class="fa fa-list mr-2"></i>Edit Additional items</a>
								</li>
							</ul>
						</div>
					            ...
					            <div class="row">
					            	<div class="col-md-7">
						            	...
						            	<div class="form-group">
							        		...
							        		<input type="text" name="item" class="form-control" id="name" placeholder="<?=$item;?>">
							        	</div>
						            	<div class="form-group">
							        		<label for="email">Price</label>
							        		<input type="text" name="price" class="form-control" id="price" placeholder="<?=$price;?>">
							        		<input type="text" name="$item_id" class="form-control" id="price" placeholder="<?=$id;?>">
							        	</div>
