<?php
    ...
    $additionalFacility = get_additional_facility();
...
<html lang="en" dir="ltr">
	<head>
		<meta charset="UTF-8">
		<title><?= $application_name; ?> |Additional Facility List</title>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark"><small>Additional Facility List</small></h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									<li class="breadcrumb-item"><a href="<?= $base_url; ?>dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
									<li class="breadcrumb-item active">Additional Facility List</li>
								</ol>
							</div>
							<!-- /.col -->
						</div>
					...
					<div class="card">
						<div class="card-header">
							<ul class="nav nav-tabs align-items-end card-header-tabs w-100">
								<li class="nav-item">
									<a class="nav-link active" href="#"><i class="fa fa-list mr-2"></i>Additional Facility List</a>
								</li>
							</ul>
						</div>
						<div class="card-body">
							...
							<table id="example2" class="table table-bordered table-hover">
				                ...
				                <tbody>
				                	...
				                	<?php
                               if (!empty($additionalFacility)) {
                                    foreach ($additionalFacility as $item) {
                                      echo "<tr><td>{$item['facility']}</td><td>{$item['price']}</td><td><div class=\"btn-group btn-group-sm\"><a href=\"edit-additional-facility.php?id={$item['id']}\" class=\"btn btn-link\"><i class=\"fa fa-edit\"></i>
												</a><form method=\"POST\" action=\"delete-facility.php?id={$item['id']}\" accept-charset=\"UTF-8\"><button type=\"submit\" class=\"btn btn-link text-danger\" onclick=\"return confirm('Are you sure?')\"><i class=\"fa fa-trash\"></i></button>
												</form></div></td></tr>";
                                    }
                               }
                               ?>
